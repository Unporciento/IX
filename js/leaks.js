...
// Textura radial suave reutilizada para el charco de la fuga (borde difuso,
// más oscuro/opaco al centro, en vez de un cuadrado de color plano).
let _puddleTex = null;
function _getPuddleTex() {
...
export function initLeaks(scene) {
  ...
  // Charco en el suelo — textura radial suave (no un plano de color plano
  // con borde duro, que se veía como un cuadrado azul pegado en el piso)
  _puddle = new THREE.Mesh(
    new THREE.PlaneGeometry(3, 3),
    new THREE.MeshBasicMaterial({
      map: _getPuddleTex(), color: 0x3a7aa8, transparent: true, opacity: 0.75, depthWrite: false,
    })
  );
