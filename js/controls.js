...
const VIEWS = {
  ...
  // ── Vista General ──────────────────────────────────────────────────────────
  // Perspectiva isométrica frontal: ve toda la urbanización de una vez
  general: {
  ...
  // Zoom lateral derecho, apuntando al edificio industrial junto al mar
  plant: {
  ...
  // ── Red y Estanques ────────────────────────────────────────────────────────
  // Vista trasera elevada: enfoca la montaña, el estanque y los tubos de bajada
  network: {
